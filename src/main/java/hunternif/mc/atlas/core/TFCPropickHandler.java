...
import su.tfcsurvival.api.events.ProspectEvent;
import su.tfcsurvival.objects.blocks.stone.BlockOreTFC;
import su.tfcsurvival.objects.items.tool.ItemProspectorPick.ProspectResult;
